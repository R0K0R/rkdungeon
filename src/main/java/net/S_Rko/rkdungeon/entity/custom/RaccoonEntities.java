package net.S_Rko.rkdungeon.entity.custom;
...
public class RaccoonEntities extends AnimalEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public RaccoonEntities(EntityType<? extends AnimalEntity> entityType, World world) {
